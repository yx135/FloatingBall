...
#include <memory>
#include "../src/modules/translate/TranslateManager.h"
...
QT_MOC_LITERAL(1, 17, 10), // "translated"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 4) // "text"

    },
    "TranslateManager\0translated\0\0text"
};
...
void TranslateManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->translated((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TranslateManager::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TranslateManager::translated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TranslateManager::translated(QString _t1)
{
