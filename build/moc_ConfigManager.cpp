...
QT_MOC_LITERAL(3, 29, 3) // "key"
    ...
    "ConfigManager\0configChanged\0\0key"
};
...
void ConfigManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->configChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
...
// SIGNAL 0
void ConfigManager::configChanged(const QString & _t1)
{
