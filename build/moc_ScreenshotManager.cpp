...
#include <memory>
#include "../src/modules/screenshot/ScreenshotManager.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ScreenshotManager_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ScreenshotManager_t qt_meta_stringdata_ScreenshotManager = {
    {
QT_MOC_LITERAL(0, 0, 17), // "ScreenshotManager"
QT_MOC_LITERAL(1, 18, 15), // "startScreenshot"
QT_MOC_LITERAL(2, 34, 0) // ""

    },
    "ScreenshotManager\0startScreenshot\0"
};
...
void ScreenshotManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->startScreenshot(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject ScreenshotManager::staticMetaObject = { {
    QMetaObject::SuperData::link<ModuleBase::staticMetaObject>(),
    qt_meta_stringdata_ScreenshotManager.data,
